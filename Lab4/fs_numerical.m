...
% reconstructing 5 cycles

t_reconstracted=linspace(t_single_period(1),5*(t_single_period(end)-t_single_period(1)),...
    5*length(x_single_period));
